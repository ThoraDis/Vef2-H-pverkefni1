...
async function upsertPlace(i: number) {
...
async function upsertEvent(i: number) {
...
async function upsertImage(i: number) {
...
async function upsertMedia(i: number) {
...
async function upsertTicket(i: number) {
